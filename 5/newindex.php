...
echo "<div style='text-align: center; margin: 20px 0;'>
    <p style='color: #4a8f7b; font-size: larger; font-weight: 600;'>
...
echo "<div style='
    ...
    <p style='margin: 0;'>Ваш логин: " . htmlspecialchars($login) . "</p></div>";
...
echo "<div style='
    ...
    <p style='margin: 0;'>Ваш пароль: " . htmlspecialchars($password) . "</p></div>";
...
echo "<div style='margin-top: 20px;'>
    ...
    href='mainpage.html'
    onmouseover=\"this.style.color='#ff9aa2'; this.style.backgroundColor='#f0f9ff';\"
    onmouseout=\"this.style.color='#4a4e69'; this.style.backgroundColor='#f8fbff';\">
    Вернуться на главную страницу</a></div>";
